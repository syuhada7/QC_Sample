...
<section class="content">
    <div class="box">
        <div class="box-header">
            ...
            <h3 class="box-title"><?= ucfirst($page) ?> Checksheet Bottom</h3>
        ...
        <div class="box-body">
            ...
            <form action="<?= base_url('Injection_C/process_bt'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="berat_1" class="form-control">
                                        <br>
                                        <input type="text" name="berat_2" class="form-control">
                                    </td>
