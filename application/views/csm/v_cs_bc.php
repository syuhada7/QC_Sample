    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <a href="<?= site_url('Injection_C/index_m'); ?>" class="btn btn-warning">
                        ...
                        <ftooter>
                            ...
                            <tr>
                                <?php if ($rw->u_updated != null && $rw->u_approved == null && $rw->u_rejected == null) { ?>
                                    ...
                                    <th><?= $rw->u_updated; ?></th>
                                    <th rowspan="2">
                                        <input type="hidden" name="u_approved" value="<?= $ids; ?>">
                                        <button class="btn btn-success" type="submit" name="approved">
                                ...
                                <th colspan="4" rowspan="2">
                                    ...
                                    <input type="hidden" name="dt_approved" class="form-control" <?= date_default_timezone_set("Asia/Jakarta"); ?> value="<?= date('Y-m-d H:i:s') ?>">
                                </th>
                            </tr>
                            <tr>
