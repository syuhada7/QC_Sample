...
<section class="content">
    <div class="box">
        <div class="box-header">
            ...
            <h3 class="box-title">Resume Checksheet Injection - Back Cover</h3>
            <div class="pull-right">
                <Span hidden><?= $id = $this->fungsi->user_login()->id_user; ?></Span>
                <a href="<?= site_url('Injection_C/index_l'); ?>" class="btn btn-warning">
        ...
        <div class="box-body">
            <?php foreach ($row as $rw) : ?>
                ...
                <form action="<?= base_url('Injection_C/approval'); ?>" method="post" enctype="multipart/form-data">
                    <table class="table-wrapper">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <span><?= $rw->d_spek2; ?></span>
                                </td>
                                <td>
                                    <span><?= $rw->d_aktual1; ?></span>
                                    <br>
                                    <span><?= $rw->d_aktual2; ?></span>
                                    <br>
                                    <span><?= $rw->d_aktual3; ?></span>
                                    <br>
                                    <span><?= $rw->d_aktual4; ?></span>
                                    <br>
                                    <span><?= $rw->d_aktual5; ?></span>
                                </td>
                                <td>
                                ...
                                <td><span><?= $rw->hs_spek; ?></span></td>
                                <td>
                                    <span><?= $rw->hs_aktual1; ?></span>
                                    <br>
                                    <span><?= $rw->hs_aktual2; ?></span>
                                    <br>
                                    <span><?= $rw->hs_aktual3; ?></span>
                                    <br>
                                    <span><?= $rw->hs_aktual4; ?></span>
                                </td>
                                <td><span><?= $rw->suhu; ?></span></td>
                                <td><span><?= $rw->berat_1; ?></span></td>
                                ...
                                <td><span><?= $rw->lb_av; ?></span></td>
                                <td><span><?= $rw->lb_decor; ?></span></td>
                                ...
                                <td><span><?= $rw->vh_spek; ?></span></td>
                                <td>
                                    <span><?= $rw->vh_aktual1; ?></span>
                                    <br>
                                    <span><?= $rw->vh_aktual2; ?></span>
                                    <br>
                                    <span><?= $rw->vh_aktual3; ?></span>
                                    <br>
                                    <span><?= $rw->vh_aktual4; ?></span>
                                </td>
                                <td>
                        ...
                        <ftooter>
                            ...
                            <tr>
                                <td colspan="34"><input type="hidden" name="id_cs" value="<?= $rw->id_cs; ?>"></td>
                            </tr>
                            <tr>
                                <th>Submit</th>
                                <th>Reject</th>
                            ...
                            <tr>
                                <?php if ($rw->u_updated == null && $rw->u_approved == null && $rw->u_rejected == null) { ?>
                                    <th><?= $rw->nama_pic; ?></th>
                                    <?php
                                    $ids = $this->fungsi->user_login()->nama_pic;
                                    ?>
                                    <th rowspan="2">
                                        <input type="hidden" name="u_rejected" value="<?= $ids; ?>">
                                        <button class="btn btn-danger" type="submit" name="rejected">
                                            <i class=" fa fa-close"></i> Reject
                                        </button>
                                    </th>
                                    <th rowspan="2">
                                        <input type="hidden" name="u_updated" value="<?= $ids; ?>">
                                        <button class="btn btn-success" type="submit" name="updated">
                                ...
                                <th colspan="4" rowspan="2">
                                    <textarea name="kt_reject"></textarea>
                                    <input type="hidden" name="dt_updated" class="form-control" <?= date_default_timezone_set("Asia/Jakarta"); ?> value="<?= date('Y-m-d H:i:s') ?>">
                                </th>
                            </tr>
                            <tr>
