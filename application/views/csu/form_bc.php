...
<section class="content">
    <div class="box">
        <div class="box-header">
            ...
            <h3 class="box-title"><?= ucfirst($page) ?> Checksheet Injection C</h3>
        ...
        <div class="box-body">
            ...
            <form action="<?= base_url('Injection_C/process_bc'); ?>" method="post" enctype="multipart/form-data" id="data">
                    ...
                    <div class="form-group row">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="lb_sn1" class="form-control" id="barcode-input1" autocomplete="off">
                                    <br>
                                    <input type="text" name="lb_sn2" class="form-control" id="barcode-input2" autocomplete="off">
                                    <br>
                                    <input type="text" name="lb_sn3" class="form-control" id="barcode-input3" autocomplete="off">
                                    <br>
                                    <input type="text" name="lb_sn4" class="form-control" id="barcode-input4" autocomplete="off">
                                    <br>
                                    <input type="text" name="lb_sn5" class="form-control" id="barcode-input5" autocomplete="off">
                                </td>
                                <td><input type="text" name="lb_av" class="form-control" id="barcode-input6" autocomplete="off"></td>
                                <td><input type="text" name="lb_decor" class="form-control" id="barcode-input7" autocomplete="off"></td>
                            ...
                            <tr>
                                <th colspan="34">
                                    <div class="notes">
                                        <div class="form-group">
                                            <div class="pull-left">
                                                <button class="btn btn-success" type="submit" name="<?= $page ?>" id="submitBtn">
...
<!-- /.content -->
<script>
    document.getElementById("barcode-input1").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input2").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input3").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input4").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input5").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input6").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("barcode-input7").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            event.preventDefault();
        }
    });
    document.getElementById("submitBtn").addEventListener("click", function() {
        document.getElementById("data").submit(); // Submit manual saat tombol diklik
    });
</script>